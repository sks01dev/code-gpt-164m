...
def load_model():
    ...
    try:
        ...
        st.success("Loaded model checkpoint `code_gpt.pt` successfully!")
    except FileNotFoundError:
        st.info("Checkpoint `code_gpt.pt` not found locally. Running baseline initialized weights.")
